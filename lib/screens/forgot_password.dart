...
import 'package:bookd/screens/reset_password.dart';
...
class _ForgotPassword extends State<ForgotPassword> {
  ...
  void _submit({required String email}) async {
    ...
    http.Response emailValiid =
        await authService.forgotPasswordValidation(email: email, otp: _otp);
  ...
  Widget build(context) {
    return Scaffold(
      appBar: const PreferredSize(
        ...
        child: TopNavBar(category: 'Forgot Password'),
      ),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.max, children: [
            ...
            SizedBox(child: Text(widget.email)),
            SizedBox(
              height: 30,
            ),
            Form(
            ...
            TextButtonConfig(
              ...
              nav: () async {
                http.Response emailValiid = await authService
                    .forgotPasswordValidation(email: widget.email, otp: _otp);
              },
            ),
          ]),
        ),
